...
return [
    'index' => [
        ...
        'header_sub' => 'Contrôler votre serveur en temps réel',
    ],
    'schedule' => [
        'header' => 'Gestionnaire des tâches',
        'header_sub' => 'Gérer toutes vos tâches journalières',
        ...
        'task_help' => 'Le temps pour les tâches est relatif à l\'ancienne tâche définie. Chaque programme ne doit pas avoir plus de 5 tâches assignées et les tâches ne peuvent pas être programmées pour plus de 15 minutes.',
    ],
    'tasks' => [
        'task_created' => 'Une nouvelle tâche a été ajoutée avec succès sur le panneau.',
        'task_updated' => 'La tâche a été modifié avec succès. Toutes les actions de tâche actuellement en attente seront annulées et réexécutées à la prochaine heure définie.',
        'header' => 'Tâches programmées',
        'header_sub' => 'Automatiser votre serveur.',
        'current' => 'Tâches actuellement programmées',
        'actions' => [
        ...
        'new' => [
            ...
            'payload_help' => 'Par exemple, si vous sélectionnez <code>Envoyer commande</code> entrez la commande ici. Si vous sélectionnez <code>Envoyer une option d\'alimentation</code> mettez l\'action  d\'alimentation ici (ex. <code>Redémarrer</code>).',
        ],
        'edit' => [
    ...
    'users' => [
        ...
        'header_sub' => 'Contrôler qui peux accéder à votre serveur.',
        ...
        'user_assigned' => 'Un nouveau sous-utilisateur a été assigné au serveur avec succès.',
        ...
        'new' => [
            ...
            'email_help' => 'Entrez l\'adrresse e-mail de l\'utilisateur auquel vous souhaitez inviter à gérer ce serveur.',
            ...
            'database_header' => 'Gestion de la base de données',
            'power_start' => [
                'title' => 'Démarrer le serveur',
                'description' => 'Autorise des utilisateurs à démarrer le serveur.',
            ],
            'power_stop' => [
                'title' => 'Arrêter le serveur',
                'description' => 'Autorise des utilisateurs à arrêter le serveur.',
            ],
            'power_restart' => [
                'title' => 'Redémarrer le serveur',
                'description' => 'Autorise des utilisateurs à redémarrer le serveur.',
            ],
            'power_kill' => [
                'title' => 'Tuer le serveur',
                'description' => 'Autorise des utilisateurs à tuer le serveur.',
            ],
            'send_command' => [
                'title' => 'Envoyer une commande de console',
                'description' => 'Autorise l\'envoi de commandes dans la console. Si l\'utilisateur n\'a pas les permissions pour arrêter ou redémarrer, il ne pourra pas envoyer la commande d\'arrêt.',
            ],
            'access_sftp' => [
                'title' => 'Autorisation sFTP',
                'description' => 'Autorise des utilisateurs à se connecter au serveur sFTP fourni par le daemon.',
            ],
            'list_files' => [
                'title' => 'Lister les fichiers',
                'description' => 'Autorise des utilisateurs à avoir une liste de tous les fichiers et dossiers sans pouvoir voir le contenu des fichiers.',
            ],
            'edit_files' => [
                'title' => 'Editer des fichiers',
                'description' => 'Autorise des utilisateurs à ouvrir un fichier en lecture unique. Le sFTP n\'est pas affecté par cette permission.',
            ],
            'save_files' => [
                'title' => 'Sauvegarder des fichiers',
                'description' => 'Autorise des utilisateurs à sauvegarder des fichiers. Le sFTP n\'est pas affecté par cette permission.',
            ],
            'move_files' => [
                'title' => 'Renommer & déplacer des fichiers',
                'description' => 'Autorise des utilisateurs à copier et déplacer des fichiers sur le système de fichiers.',
            ],
            'copy_files' => [
                'title' => 'Copier des fichiers',
                'description' => 'Autorise des utilisateurs à copier des fichiers et dossiers.',
            ],
            'compress_files' => [
                'title' => 'Compresser des fichiers',
                'description' => 'Autorise des utilisateurs à compresser des fichiers et dossiers en une archive.',
            ],
            'decompress_files' => [
                'title' => 'Décompresser des fichiers',
                'description' => 'Autorise des utilisateurs à decompresser des archives de type ".zip" et ".tar(.gz)".',
            ],
            'create_files' => [
                'title' => 'Créer des fichiers',
                'description' => 'Autorise des utilisateurs à créer des fichiers et dossiers.',
            ],
            'upload_files' => [
                'title' => 'Mettre en ligne des fichiers',
                'description' => 'Autorise des utilisateurs à mettre en ligne des fichiers et dossiers.',
            ],
            'delete_files' => [
                'title' => 'Supprimer des fichiers',
                'description' => 'Autorise des utilisateurs à supprimer des fichiers et dossiers.',
            ],
            'download_files' => [
                'title' => 'Télécharger des fichiers',
                'description' => 'Autorise des utilisateurs à télécharger des fichiers. Si un utilisateur a cette permission, il peut télécharger et lire le contenu des fichiers même si cette permission n\'est pas assignée au panel.',
            ],
            'list_subusers' => [
                'title' => 'Afficher les sous-utilisateurs',
                'description' => 'Autorise des utilisateurs à voir une liste de tous les sous-utilisateurs assignés au serveur.',
            ],
            'view_subuser' => [
                'title' => 'Voir les sous-utilisateurs',
                'description' => 'Autorise des utilisateurs à view les permissions assignées aux sous-utilisateurs.',
            ],
            'edit_subuser' => [
                'title' => 'Modifier le sous-utilisateur',
                'description' => 'Autorise un utilisateur à modifier les permissions assignées aux autres sous-utilisateurs.',
            ],
            'create_subuser' => [
                'title' => 'Créer un sous-utilisateur',
                'description' => 'Autorise aux utilisateurs de créer des sous-utilisateurs additionnels sur le serveur.',
            ],
            'delete_subuser' => [
                'title' => 'Supprimer un sous-utilisateur',
                'description' => 'Autorise un utilisateur à supprimer d\'autres sous-utilisateurs sur le serveur.',
            ],
            'view_allocations' => [
                'title' => 'Voir les allocations',
                'description' => 'Autorise un utilisateur à voir tous les IPs et ports assignés au serveur.',
            ],
            'edit_allocation' => [
                'title' => 'Modifier la connection par défaut',
                'description' => 'Autorise les utilisateurs à changer l\'allocation de connectionpar défaut pour utiliser un serveur.',
            ],
            'view_startup' => [
                'title' => 'Voir la commande de démarrage',
